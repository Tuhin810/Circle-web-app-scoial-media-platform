  ...
  return (
    <div className="flex justify-center">
      <div className="flex gap-2 px-5">
        <div className="flex mt-3 w-44 h-14 bg-white text-black border border-black rounded-xl items-center justify-center">
          <div className="mr-3">
        ...
        <div className="flex mt-3 w-44 h-14 bg-white text-white border border-black rounded-lg items-center justify-center">
          <div className="mr-3">
